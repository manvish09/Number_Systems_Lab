...
export default function DecimalToBaseExplanation({
  ...
  const integerResult = result.split(".")[0];

  const fractionResult = result.includes(".")
    ? result.split(".")[1]
    : "";

  const remainderDigits = [...divisionSteps]
    .reverse()
    .map((step) =>
      step.remainder
        .toString(targetBase)
  ...
  return (
    <div className="space-y-8">
      ...
      <StepCard title="Collected Remainders">
        <RemainderStrip
        ...
        >
          ...
          <div className="mb-6 rounded-xl border bg-slate-50 p-5">
            ...
            <div className="mt-3 text-sm text-slate-600">
              ...
              {fractionConversion.rounded && (
                <>
                  The expansion did not terminate
                  within the configured precision.
                  Display has been rounded to{" "}
                  <strong>
                    {fractionConversion.precision}
                  </strong>{" "}
                  digits.
          ...
          {fractionConversion.recurring &&
            fractionConversion.recurringStartIndex !==
              undefined && (
              <div className="mt-5 rounded-xl border border-orange-200 bg-orange-50 p-4">
                ...
                <div className="mt-2 text-sm text-slate-600">
                  The repeating sequence begins after
                  digit{" "}
                  <strong>
                    {fractionConversion.recurringStartIndex +
                      1}
